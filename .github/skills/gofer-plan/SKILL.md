---
name: gofer-plan
description: "Run the gofer_plan Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: gofer_plan
  canonicalSource: .claude/commands/gofer_plan.md
  canonicalChecksum: 6e87253512db890aa29e64a90de27ec518a8c7241f5ad102decd574853bad1aa
  metadataSource: eai/resources/gofer
---

# Gofer Command: gofer_plan

Use this skill when the user asks for `gofer_plan`, `#gofer_plan`, or `gofer-plan`.

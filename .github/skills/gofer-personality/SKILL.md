...
description: "Run the gofer_personality Gofer workflow stage"
gofer:
  workflowProfile: enterpriseai
  canonicalCommand: gofer_personality
  canonicalSource: .claude/commands/gofer_personality.md
  canonicalChecksum: 9682d1dad87ce55681faab6d25bfe5054aca398d6c19072b69899864b8e64da6
  metadataSource: eai/resources/gofer
---

# Gofer Command: gofer_personality

Use this skill when the user asks for `gofer_personality`, `#gofer_personality`, or `gofer-personality`.

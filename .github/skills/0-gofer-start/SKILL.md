...
gofer:
  ...
  canonicalCommand: 0_gofer_start
  canonicalSource: .claude/commands/0_gofer_start.md
  canonicalChecksum: 52d211c5a8de9eb3b9662e30022a943be29e314053ad36c7b99f0fc0d0749681
  metadataSource: eai/resources/gofer
---

# Gofer Command: 0_gofer_start

Use this skill when the user asks for `0_gofer_start`, `#0_gofer_start`, or `0-gofer-start`.
